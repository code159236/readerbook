...
1.自定义站点，自己设置规则，抓取网页数据，规则简单易懂，软件内有规则说明。<br>
2.列表书架，网格书架自由切换。<br>
3.站点规则支持搜索及站点，所有找书看书功能全部自定义，找书更方便。<br>
...
* [Coolapk](https://www.coolapk.com/apk/com.v2reading.reader.release)
* [Jsdelivr](https://cdn.jsdelivr.net/gh/gedoor/release@release/)
* [\#Beta](https://kunfei.lanzoui.com/b0f810h4b)
* [IzzyOnDroid F-Droid Repository](https://apt.izzysoft.de/fdroid/index/apk/com.v2reading.reader.release)
...
* path类型解释: 站点,订阅源,替换规则,本地txt小说目录规则,在线朗读引擎,主题,阅读排版
...
##### 阅读3.0
* [站点规则](https://alanskycn.gitee.io/teachme)
