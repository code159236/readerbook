...
object SourceAnalyzer {
    ...
    data class BookSourceAny(
        ...
        var enabledExplore: Boolean = true,             // 启用站点
        ...
        var bookSourceComment: String? = "",            //站点注释
        var lastUpdateTime: Long = 0,                   // 最后更新时间，用于排序
        var respondTime: Long = 180000L,                // 响应时间，用于排序
        var weight: Int = 0,                            // 智能排序的权重
        var exploreUrl: String? = null,                 // 站点url
        var ruleExplore: Any? = null,                   // 站点规则
