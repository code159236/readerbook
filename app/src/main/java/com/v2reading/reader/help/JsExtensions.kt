...
import com.v2reading.reader.constant.AppConst.dateFormat
...
import com.v2reading.reader.help.http.BackstageWebView
import com.v2reading.reader.help.http.CookieStore
import com.v2reading.reader.help.http.SSLHelper
...
//******************文件操作************************//
     ...
     * 解析字体,返回字体解析类
     */
    fun queryBase64TTF(base64: String?): com.v2reading.reader.model.analyzeRule.QueryTTF? {
        base64DecodeToByteArray(base64)?.let {
            return com.v2reading.reader.model.analyzeRule.QueryTTF(it)
        }
        return null
    }
     ...
     */
    fun queryTTF(str: String?): com.v2reading.reader.model.analyzeRule.QueryTTF? {
        str ?: return null
        try {
            ...
            font ?: return null
            qTTF = com.v2reading.reader.model.analyzeRule.QueryTTF(font)
    ...
    fun replaceFont(
        text: String,
        errorQueryTTF: com.v2reading.reader.model.analyzeRule.QueryTTF?,
        correctQueryTTF: com.v2reading.reader.model.analyzeRule.QueryTTF?
    ): String {
