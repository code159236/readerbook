...
import com.v2reading.reader.databinding.ItemPathFilepickerBinding
...
class PathAdapter(context: Context, val callBack: CallBack) :
    ...
    private val arrowIcon = ConvertUtils.toDrawable(com.v2reading.reader.ui.document.utils.FilePickerIcon.getArrow())
