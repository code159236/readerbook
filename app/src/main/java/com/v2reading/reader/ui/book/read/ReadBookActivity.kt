...
import com.v2reading.reader.receiver.TimeBatteryReceiver
...
import com.v2reading.reader.ui.book.changesource.ChangeChapterSourceDialog
import com.v2reading.reader.ui.book.read.config.*
import com.v2reading.reader.ui.book.read.config.BgTextConfigDialog.Companion.BG_COLOR
import com.v2reading.reader.ui.book.read.config.BgTextConfigDialog.Companion.TEXT_COLOR
import com.v2reading.reader.ui.book.read.config.TipConfigDialog.Companion.TIP_COLOR
import com.v2reading.reader.ui.book.read.page.ContentTextView
import com.v2reading.reader.ui.book.read.page.ReadView
import com.v2reading.reader.ui.book.read.page.entities.PageDirection
import com.v2reading.reader.ui.book.read.page.provider.TextPageFactory
import com.v2reading.reader.ui.book.searchContent.SearchContentActivity
import com.v2reading.reader.ui.book.searchContent.SearchResult
...
import com.v2reading.reader.ui.dict.DictDialog
import com.v2reading.reader.ui.login.SourceLoginActivity
import com.v2reading.reader.ui.replace.ReplaceRuleActivity
import com.v2reading.reader.ui.replace.edit.ReplaceEditActivity
import com.v2reading.reader.ui.widget.PopupAction
            ...
            for (i in 0 until menu.size) {
                ...
                when (item.groupId) {
                    ...
                    R.id.menu_group_text -> item.isVisible = book.isLocalTxt()
                        ...
                        R.id.menu_reverse_content -> item.isVisible = false
                    }
                }
            }
            launch {
...
//        showDialogFragment(TextDialog(text, TextDialog.Mode.MD))
     ...
     * 显示亮度配置
     */
    override fun showReadBrightnessStyle() {
        showDialogFragment<ReadBrightnessDialog>()
    }
...
//            readMenu.upBrightnessState()
        ...
        observeEvent<Boolean>(EventBus.AUTO_PAGE) {
            autoPage()
        }

        observeEvent<Boolean>(EventBus.GLOBAL_SEARCH) {
            openSearchActivity(null)
        }
        observeEvent<Boolean>(EventBus.OPEN_MORE_SETTING) {
            showMoreSetting()
        }
