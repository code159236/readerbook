...
import com.v2reading.reader.lib.theme.getPrimaryDisabledTextColor
...
class FileAdapter(context: Context, val callBack: CallBack) :
    ...
    var currentPath: String? = null
        private set
    private val homeIcon = ConvertUtils.toDrawable(com.v2reading.reader.ui.document.utils.FilePickerIcon.getHome())
    private val upIcon = ConvertUtils.toDrawable(com.v2reading.reader.ui.document.utils.FilePickerIcon.getUpDir())
    private val folderIcon = ConvertUtils.toDrawable(com.v2reading.reader.ui.document.utils.FilePickerIcon.getFolder())
    private val fileIcon = ConvertUtils.toDrawable(com.v2reading.reader.ui.document.utils.FilePickerIcon.getFile())
