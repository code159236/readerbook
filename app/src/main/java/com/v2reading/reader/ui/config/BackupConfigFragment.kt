...
import com.v2reading.reader.help.storage.BackupConfig
import com.v2reading.reader.help.storage.ImportOldData
...
class BackupConfigFragment : PreferenceFragment(),
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<com.v2reading.reader.lib.prefs.Preference>("web_dav_restore")
